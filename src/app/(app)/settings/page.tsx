  ...
  const hotkeyCategories: HotkeyCategory[] = [
    {
      ...
      items: [
        ...
        { action: "Go to Follow-ups", description: "Navigate to email reminders list", keys: ["Shift", "F"] },
        { action: "Go to Archives", description: "Navigate to email reminders list", keys: ["Shift", "A"] },
        { action: "Go to Trash", description: "Navigate to email reminders list", keys: ["Shift", "T"] },
