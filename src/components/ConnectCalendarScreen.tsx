          ...
          <div className="relative p-10 md:p-12">
            ...
            <div className="text-center">
              ...
              <p className="mt-4 text-base leading-7 text-[#8b949e] max-w-lg mx-auto">
                Connect your Google Calendar to manage events, schedule
                meetings, create reminders, and keep your timeline synchronized
                in real time.
              </p>
            </div>
            ...
            <div className="mt-10 grid gap-3 md:grid-cols-3">
              ...
              <div className="rounded-xl border border-gray-800 bg-[#0e1116] p-4">
                ...
                <div className="text-sm text-[#8b949e]">
                  Coordinate meetings across calendars.
                </div>
              </div>
              ...
              <div className="rounded-xl border border-gray-800 bg-[#0e1116] p-4">
                ...
                <div className="text-sm text-[#8b949e]">
                  Stay up to date with calendar changes instantly.
                </div>
              </div>
            </div>
